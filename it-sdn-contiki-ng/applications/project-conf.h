...
#define SDN_CONF_CD naive_directed_cd
...
// #define RDC_CONF_UNIDIR_SUPPORT 1
...
#define SDN_PACKETBUF_POOL_SIZE 20
/* Size of SDN send queue. */
#define SDN_SEND_QUEUE_SIZE (SDN_PACKETBUF_POOL_SIZE - 2)
/* Size of SDN recv queue. */
#define SDN_RECV_QUEUE_SIZE (SDN_PACKETBUF_POOL_SIZE - 2)
