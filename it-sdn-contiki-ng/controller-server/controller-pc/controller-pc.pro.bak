...
#LIBS += -L/home/renan/code/tests/staticlib -lmylib

include(controller-pc.pro.contiki)

INCLUDEPATH+=$$CONTIKI/os/
INCLUDEPATH+=$$CONTIKI/arch/platform/cooja/
INCLUDEPATH+=../../sdn-common/
INCLUDEPATH+=../
INCLUDEPATH+=../digraph/
#INCLUDEPATH+=/home/renan/code/tests/staticlib/
